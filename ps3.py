...
min_lower_monthly_payment = x/12 
max_lower_monthly_payment = x * (1 + y)/12
balance = x
interest_paid = y/12
min_mon_payment = min_lower_monthly_payment
new_balance = balance
while new_balance > 0:
	min_mon_payment += 0.1
	new_balance = balance
...
print 'Min monthly payment : ',min_lower_monthly_payment
print 'Max monthly payment : ',max_lower_monthly_payment
